...
public class Activity6 {
	...
	public void loginSuccessTest() {
		...
		wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.xpath(
				"//android.webkit.WebView[@text=\"Popups\"]/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.widget.EditText[1]")))
				.sendKeys("admin");
		...
		WebElement credentials = driver
				.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Welcome Back, admin\"]"));
	...
	public void loginUnsuccessTest() {
		...
		driver.findElement(AppiumBy.xpath("//android.widget.Button[@text=\"Log in\"]")).click();
		WebElement credentials = driver
				.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Invalid Credentials\"]"));
		String mgs = credentials.getText();
