...
public class Activity3 {
	...
	public void setup() throws MalformedURLException, URISyntaxException {
		...
		UiAutomator2Options caps = new UiAutomator2Options().setPlatformName("andriod")
				.setAutomationName("UiAutomator2").setAppPackage("com.google.android.keep")
				.setAppActivity("com.google.android.apps.keep.ui.activities.BrowseActivity").noReset();
	...
	public void googleKeepTest() {
		...
		driver.findElement(AppiumBy.xpath(
				"//android.widget.TextView[@resource-id=\"com.google.android.keep:id/title\" and @text=\"Reminders\"]"))
				.click();
